...
replaceAndIndex : index elem (replaceAt elem x elements) = x
...
replaceAndIndexElsewhere : (elem1 = elem2 -> Void) -> index elem1 (replaceAt elem2 x elements) = index elem1 elements
...
replaceOrder : (elem1 = elem2 -> Void) -> replaceAt elem2 x2 (replaceAt elem1 x1 elements) = replaceAt elem1 x1 (replaceAt elem2 x2 elements)
